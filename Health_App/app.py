...
the total calories, also provide the details of every food items with calorie intake in below format
1. Item 1 - no of calories
2. Item 2 - no of calories
-----
-----
Finally you can also mention whether the food is healthy or not and also
mention the percentage split of the ratio of carbohydrates, fats, fibers, sugar, and protein and other 
important nutrients that are required in our diet.
"""
